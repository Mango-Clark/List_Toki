spare = 20
n = int(input("Update Number: "))

readme = f'''# List_Toki

[**Current Version: {n}.0**](https://github.com/Mango-Clark/List_Toki/blob/main/List_Toki.txt)
...
list_toki = f'''! Title: List_Toki
! Description: Adblock list for toki services.
! Version: {n}.0
! Expires: 12 hours
! Homepage: https://github.com/Mango-Clark/List_Toki
! Test environment: Brave browser
! Note: For more convenience, use this filter list with List-KR(https://github.com/List-KR/List-KR) and other AdBlock services.(ABP, uBO, Brave browser...)

newtoki{n}.com,booktoki{n}.com,manatoki{n}.net###hd_pop
newtoki{n}.com,booktoki{n}.com,manatoki{n}.net#?#:has(> div > a[href*="linkbn.php"])
newtoki{n}.com,booktoki{n}.com#?#:has(> a[href^="https://t.me/"])
newtoki{n}.com,booktoki{n}.com###main-banner-view > div.col-15.col-md-9.col-sm-9
newtoki{n}.com,booktoki{n}.com###id_mbv > div.col-15.col-md-9.col-sm-9

'''
for i in range(n + 1, n + spare):
	list_toki += f'newtoki{i}.com,booktoki{i}.com,manatoki{i}.net,'
list_toki = list_toki[:-1] + '###hd_pop\n'
for i in range(n + 1, n + spare):
	list_toki += f'newtoki{i}.com,booktoki{i}.com,manatoki{i}.net,'
list_toki = list_toki[:-1] + '#?#:has(> div > a[href*="linkbn.php"])\n'

for i in range(n + 1, n + spare):
	list_toki += f'newtoki{i}.com,booktoki{i}.com,'
list_toki = list_toki[:-1] + '#?#:has(> a[href^="https://t.me/"])\n'
for i in range(n + 1, n + spare):
	list_toki += f'newtoki{i}.com,booktoki{i}.com,'
list_toki = list_toki[:-1] + '###main-banner-view > div.col-15.col-md-9.col-sm-9\n'
for i in range(n + 1, n + spare):
	list_toki += f'newtoki{i}.com,booktoki{i}.com,'
list_toki = list_toki[:-1] + '###id_mbv > div.col-15.col-md-9.col-sm-9'

open("./List_Toki.txt", "w").write(list_toki)
print(list_toki)